...
const STATUS_CLASSNAME: Record<ProductionOrderStatusType, string> = {
  ...
  [ProductionOrderStatus.Ready]: 'border-emerald-300 bg-emerald-100 text-emerald-800',
  ...
  [ProductionOrderStatus.Completed]: 'border-emerald-300 bg-emerald-100 text-emerald-800',
