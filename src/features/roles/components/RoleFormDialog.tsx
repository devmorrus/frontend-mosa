...
function RolePreview({
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50/70 px-4 py-3.5">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-slate-600 ring-2 ring-white shadow-[0_4px_12px_rgba(18,48,46,0.18)]">
        <ShieldCheck size={18} />
      </div>
