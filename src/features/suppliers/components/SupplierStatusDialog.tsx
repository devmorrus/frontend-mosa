      ...
      <DialogContent className="max-w-sm overflow-hidden rounded-[24px] p-0">
        ...
        <div className="px-6 py-6 text-center">
          ...
          <p className="mt-3 text-xs leading-relaxed text-slate-400">
            {toActive
              ? 'Supplier akan aktif kembali dan bisa dipilih di Goods Receiving baru.'
              : 'Supplier akan nonaktif dan tidak bisa dipilih di Goods Receiving baru. Riwayat transaksi lama tetap aman.'}
          </p>
        </div>
