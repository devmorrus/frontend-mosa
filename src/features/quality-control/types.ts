...
export interface QcParameterAdmin extends QcParameter { productId: string; status: number }
export interface QcParameterFormValues { productId: string; name: string; description: string; resultType: string; isRequired: boolean; sequence: string; configJson: string }
...
export interface QcGlobalHistoryItem { id: string; finishedGoodsLotId: string; lotNumber: string; productName: string; productionOrderNumber: string; status: string | number; inspectorName: string | null; inspectedAt: string | null; notes: string | null; itemCount: number }
export interface QcNcr { id: string; ncrNumber: string; finishedGoodsLotId: string; lotNumber: string; productName: string; productionOrderNumber: string | null; qcInspectionId: string | null; title: string; description: string; rootCause: string | null; correctiveAction: string | null; preventiveAction: string | null; assignedTo: string | null; dueDate: string | null; status: number; closedAtUtc: string | null; createdAtUtc: string }
