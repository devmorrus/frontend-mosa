...
export interface QcQueueItem { finishedGoodsLotId: string; lotNumber: string; productId: string; productName: string; productionOrderId: string; productionOrderNumber: string; productionDate: string; actualOutput: number; uomSymbol: string; qcStatus: string; inventoryStatus: string; createdAtUtc: string; requiredParamCount: number; optionalParamCount: number }
export interface QcInspection { inspectionId: string | null; finishedGoodsLotId: string; lotNumber: string; lotQcStatus: string; inspectionStatus: string; inspectorId: string | null; inspectorName: string | null; inspectedAt: string | null; notes: string | null; items: QcItem[]; parameters: QcParameter[] }
export interface QcHistoryItem { id: string; status: string; inspectorName: string | null; inspectedAt: string | null; notes: string | null; itemCount: number }
