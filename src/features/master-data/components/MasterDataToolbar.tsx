...
export function MasterDataToolbar({
  ...
  return (
    <div className="grid gap-3 rounded-[28px] border border-white/70 bg-white/85 p-4 shadow-sm sm:grid-cols-[minmax(0,1fr)_auto_auto] sm:items-center sm:p-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:flex">
        <select
          value={query.status}
          onChange={(event) => onStatusChange(event.target.value as MasterDataQueryState['status'])}
