      ...
      <DialogContent className="max-w-sm overflow-hidden rounded-[24px] p-0">
        ...
        <div className="px-6 py-6 text-center">
          ...
          <p className="mt-3 text-xs leading-relaxed text-slate-400">
            {toActive
              ? 'Product akan aktif kembali dan bisa dipakai lintas modul operasional.'
              : 'Product akan nonaktif dan tidak bisa dipakai di transaksi baru. Data dan riwayat lama tetap aman.'}
          </p>
        </div>
