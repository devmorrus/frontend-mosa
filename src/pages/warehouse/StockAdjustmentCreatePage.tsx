...
export function StockAdjustmentCreatePage() {
  ...
  return <div className="mx-auto max-w-4xl space-y-6">
    ...
    <Card className="rounded-[28px] border-slate-200/80"><CardHeader><CardTitle>Adjustment Form</CardTitle></CardHeader><CardContent><form onSubmit={handleSubmit} className="grid gap-5 lg:grid-cols-2">
      ...
      <div className="lg:col-span-2"><Field label="Reason" error={errors.reason}><Textarea className="mt-2 min-h-28 rounded-2xl" value={reason} onChange={(event) => setReason(event.target.value)} placeholder="Wajib. Jelaskan alasan correction." /></Field></div>
      <div className="lg:col-span-2"><Button type="submit" disabled={isSubmitting} className="h-12 w-full rounded-2xl bg-red-700 text-white hover:bg-red-800">Post Adjustment</Button></div>
