...
function tolerance(detail: ProductionDeviationDetail) { const material = detail.material; const uom = material.unitOfMeasureSymbol; return material.toleranceValue === null ? 'Tidak ada tolerance' : formatAllowedRange(material.lowerLimit, material.upperLimit, uom) }
