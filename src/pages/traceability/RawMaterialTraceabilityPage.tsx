...
function statusTone(value: string | number, type: 'qc' | 'inventory') {
  ...
  if (numericPass || numericAvailable || text.includes('pass') || text.includes('available')) return 'border-emerald-200 bg-emerald-50 text-emerald-700'
...
export function RawMaterialTraceabilityPage() {
  ...
  return <div className="space-y-6 pb-10">
    <section className="relative overflow-hidden rounded-[30px] bg-ink px-6 py-8 text-paper shadow-[0_24px_80px_rgba(18,48,46,0.16)] sm:px-8 lg:px-10">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_90%_5%,rgba(232,163,61,0.28),transparent_28%),radial-gradient(circle_at_0%_100%,rgba(88,156,142,0.22),transparent_42%)]" />
