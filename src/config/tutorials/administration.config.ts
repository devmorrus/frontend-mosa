...
export const adminUserManagementTutorial: TutorialDefinition = {
  ...
  steps: [
    ...
    { id: 'aum-3', stepNumber: 3, totalSteps: 7, title: 'Create User', instruction: 'Gunakan fitur ini untuk membuat account pengguna MOSA.', type: 'INFO', route: '/admin/users', targetSelector: '[data-tour="user-create"]', placement: 'bottom' },
    { id: 'aum-4', stepNumber: 4, totalSteps: 7, title: 'Role', instruction: 'Role menentukan kumpulan permission yang dimiliki user.', type: 'INFO', route: '/admin/users', targetSelector: '[data-tour="user-role"]', placement: 'bottom' },
    { id: 'aum-5', stepNumber: 5, totalSteps: 7, title: 'Status', instruction: 'User yang dinonaktifkan tidak dapat menggunakan account untuk mengakses aplikasi.', type: 'INFO', route: '/admin/users', targetSelector: '[data-tour="user-status"]', placement: 'bottom' },
    { id: 'aum-6', stepNumber: 6, totalSteps: 7, title: 'Revoke Sessions', instruction: 'Gunakan Revoke Sessions untuk mengakhiri session user yang masih aktif.', type: 'INFO', route: '/admin/users', targetSelector: '[data-tour="user-revoke-session"]', placement: 'bottom' },
...
export const adminRolesPermissionsTutorial: TutorialDefinition = {
  ...
  steps: [
    ...
    { id: 'arp-2', stepNumber: 2, totalSteps: 6, title: 'Pilih Role', instruction: 'Pilih role dari daftar untuk melihat detail permission.', type: 'INFO', route: '/admin/roles', targetSelector: '[data-tour="role-select"]', placement: 'bottom' },
    { id: 'arp-3', stepNumber: 3, totalSteps: 6, title: 'Permission Groups', instruction: 'Permission dikelompokkan berdasarkan module.', type: 'INFO', route: '/admin/roles', targetSelector: '[data-tour="permission-group"]', placement: 'right' },
    { id: 'arp-4', stepNumber: 4, totalSteps: 6, title: 'Simpan Permission', instruction: 'Simpan perubahan permission dengan tombol ini. Panduan saja — jangan ubah permission nyata saat tutorial.', type: 'INFO', route: '/admin/roles', targetSelector: '[data-tour="permission-save"]', placement: 'bottom' },
    { id: 'arp-5', stepNumber: 5, totalSteps: 6, title: 'Dampak Perubahan', instruction: 'Perubahan permission akan memengaruhi akses user dalam role tersebut. Verifikasi ulang sebelum menyimpan di luar tutorial.', type: 'INFO', route: '/admin/roles', targetSelector: '[data-tour="permission-save"]', placement: 'bottom' },
...
export const adminAuditTrailTutorial: TutorialDefinition = {
  ...
  steps: [
    ...
    { id: 'aat-5', stepNumber: 5, totalSteps: 8, title: 'Detail', instruction: 'Buka Audit Detail untuk melihat perubahan secara rinci.', type: 'INFO', route: '/admin/audit-trail', targetSelector: '[data-tour="audit-detail"]', placement: 'left' },
    { id: 'aat-6', stepNumber: 6, totalSteps: 8, title: 'Before / After', instruction: 'Bagian ini menunjukkan perubahan data yang direkam oleh MOSA.', type: 'INFO', route: '/admin/audit-trail', targetSelector: '[data-tour="audit-change"]', placement: 'top' },
    { id: 'aat-7', stepNumber: 7, totalSteps: 8, title: 'Read Only', instruction: 'Audit Trail bersifat read-only dan tidak dapat diedit melalui aplikasi.', type: 'INFO', route: '/admin/audit-trail', targetSelector: '[data-tour="audit-change"]', placement: 'top' },
