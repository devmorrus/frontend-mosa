...
export const adminRolesPermissionsTutorial: TutorialDefinition = {
  ...
  steps: [
    ...
    { id: 'arp-4', stepNumber: 4, totalSteps: 6, title: 'Save', instruction: 'Simpan perubahan permission dengan tombol ini.', type: 'INFO', route: '/admin/roles', targetSelector: '[data-tour="permission-save"]', placement: 'bottom' },
    { id: 'arp-5', stepNumber: 5, totalSteps: 6, title: 'Save', instruction: 'Perubahan permission akan memengaruhi akses user dalam role tersebut.', type: 'INFO', route: '/admin/roles', targetSelector: '[data-tour="permission-save"]', placement: 'bottom' },
